...
export const useGameState = () => {
  ...
  const initializeGame = useCallback(async () => {
    try {
      ...
      // Only set loading to false if authentication was successful
  ...
  useEffect(() => {
    ...
    }, GAME_CONFIG.ENERGY_REGEN_RATE / user.rechargingSpeed)
  ...
  // Don't clear URL parameters after successful auth
  // clearUrlParameters()
    user,
    gameState,
    loading,
